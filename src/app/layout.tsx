...
export const metadata: Metadata = {
  title: "Pizza Hut - Fresh Wood-Fired Pizzas | Order Online",
  description: "Enjoy authentic wood-fired pizzas with fresh ingredients at Pizza Hut. Order online for delivery or dine in. 20+ years of pizza excellence.",
  keywords: "pizza restaurant, wood-fired pizza, Italian food, pizza delivery, pizza near me",
  robots: {
    index: true,
    follow: true
  },
  openGraph: {
    title: "Pizza Hut - Fresh Wood-Fired Pizzas",
    description: "Experience authentic wood-fired pizzas with premium ingredients. Order online for delivery or enjoy dining in.",
    type: "website",
    siteName: "Pizza Hut",
    images: [{
      url: "https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763831899945-4kn03qvu.jpg",
      alt: "Delicious Pizza from Pizza Hut"
    }]
  },
  twitter: {
    card: "summary_large_image",
    title: "Pizza Hut - Fresh Wood-Fired Pizzas",
    description: "Order authentic pizzas online now",
    images: ["https://webuild-dev.s3.eu-north-1.amazonaws.com/users/user_35ggfqwTaDTPV7ncegJJc94SZmR/uploaded-1763831899945-4kn03qvu.jpg"]
  }
};
